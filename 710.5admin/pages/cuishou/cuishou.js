...
Page({
      ...
      success: (res) => {
        ...
        wx.getStorage({
          ...
          success: (res) => {
            ...
            let id = res.data
            wx.request({
              url: 'http://81.68.194.42:9090/api/1/get/record/2/' + itemnow.id,
              header: {
            ...
            wx.request({
              url: 'http://81.68.194.42:9090/api/1/get/more/phone/' + itemnow.id,
              header: {
                'content-type': 'application/json',
                'token': token
              },
            ...
            wx.request({
              url: 'http://81.68.194.42:9090/api/1/get/groups/3',
              header: {
                'content-type': 'application/json',
                'token': token
              },
            ...
            if (itemnow.isRemarkFour == 4) {
              wx.request({
                url: 'http://81.68.194.42:9090/api/1/get/record',
                data: {
                  type: 1,
                  taskId: itemnow.id
                },
            ...
            wx.request({
              url: 'http://81.68.194.42:9090/api/1/get/manage/detail/' + itemnow.id,
              header: {
                'content-type': 'application/json',
                'token': token
              },
              ...
              success: (res) => {
                ...
                for (let i = 0; i < chuzhiarr.length; i++) {
                  if (chuzhiarr[i].type != 5) {
                    wx.request({
                      url: 'http://81.68.194.42:9090/api/1/list/urls',
                      data: {
                        "type": 3,
                        "taskId": itemnow.id
                      },
                  ...
                  if (chuzhiarr[i].type == 5) {
                    wx.request({
                      url: 'http://81.68.194.42:9090/api/1/list/urls/1',
                      data: {
                        "type": 4,
                        "taskId": itemnow.id,
                        "num": i
  ...
  cuijiconfirm(e) {
    let that = this
    wx.request({
      url: 'http://81.68.194.42:9090/api/1/create/record/2',
      data: {
      ...
      success: (res) => {
        ...
        wx.showModal({
          ...
          success: function (res) {
            ...
            wx.request({
              url: 'http://81.68.194.42:9090/api/1/get/record/2/' + that.data.car.id,
              header: {
                'content-type': 'application/json',
                'token': that.data.token
              },
  ...
  cuishouwancheng(e) {
    let that = this
    wx.request({
      url: 'http://81.68.194.42:9090/api/1/get/car/' + that.data.car.id,
  ...
  addphone(e) {
    let that = this
    wx.request({
      url: 'http://81.68.194.42:9090/api/1/add/phone',
      data: {
        "taskId": that.data.car.id,
      ...
      success: (res) => {
        ...
        wx.showModal({
          ...
          success: function (res) {
            wx.request({
              url: 'http://81.68.194.42:9090/api/1/get/more/phone/' + that.data.car.id,
              header: {
                'content-type': 'application/json',
                'token': that.data.token
              },
  ...
  removephone(e) {
    ...
    wx.request({
      url: 'http://81.68.194.42:9090/api/1/remove/phone/' + phoneid,
      header: {
        'content-type': 'application/json',
        'token': that.data.token
      },
  ...
  remarkconfirm() {
    let that = this
    wx.request({
      url: 'http://81.68.194.42:9090/api/1/change/text',
      data: {
        "taskId": that.data.car.id,
  ...
  changegezhi(e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url: 'http://81.68.194.42:9090/api/1/change/group',
            data: {
              "taskId": that.data.car.id,
              'name': ''
            },
  ...
  formdataconfirm(e) {
    ...
    if (calssify == 1) {
      wx.request({
        url: 'http://81.68.194.42:9090/api/1/change/msg',
        data: {
